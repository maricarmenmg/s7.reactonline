...
<path fill-rule="evenodd" clip-rule="evenodd" d="M133.541 112.447C130.568 112.447 128.158 110.038 128.158 107.065V33.0873C128.158 30.1148 130.568 27.7051 133.541 27.7051H158.085C161.058 27.7051 163.468 30.1148 163.468 33.0873V107.065C163.468 110.038 161.058 112.447 158.085 112.447H133.541Z" fill="#CBE358"/>
</svg>
          ...
          <nav className="flex grow">
            ...
            <li className="ml-3">
              ...
              <li className="ml-3">
              <Link className="font-inter text-m text-black  w-full " to="/form">
                Proyectos
                </Link>
              </li>
              <li className="ml-3">
